...
1. Enforce open/close rules (desktop double-click, mobile double-tap, overlay, Esc).
...
17. Planner: details panel open rules (desktop double-click, mobile double-tap only).
...
Requirements:
- Desktop: double-click opens details.
